...
VAULT_REMOTE="${VAULT_REMOTE:-http://127.0.0.1:8200/}"
# Provide these as environment variables when running the demo (do not hardcode secrets).
VAULT_REMOTE_TOKEN="${VAULT_REMOTE_TOKEN:-}"
VAULT_REMOTE_UNSEAL="${VAULT_REMOTE_UNSEAL:-}"

PATH_YAML_SSH="$YAML_PATH/secret_ssh"
VAULT_SSH="172.16.85.154"
VAULT_SSH_USER="k8s"
VAULT_SSH_PASSWORD="${VAULT_SSH_PASSWORD:-}"
